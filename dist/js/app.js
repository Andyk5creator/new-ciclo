(() => {
    ...
    class FullPage {
        ...
        setActiveBullet(idButton) {
            ...
            const bullets = Array.from(this.bulletsWrapper.children);
        ...
        setBullets() {
            ...
            if (this.bulletsWrapper) this.sections.forEach((section => {
    ...
    if (document.querySelector("[data-fp]")) new FullPage(document.querySelector("[data-fp]"), "");
